...
function * login (options = {}) {
  try {
    ...
    if (typeof e === 'string' && e.match(/CLI needs to prompt for/) && os.platform() === 'win32') {
      let message = e + ' On Windows plaftorms, we recommend using cmd.exe to execute initial authentication with Heroku'
